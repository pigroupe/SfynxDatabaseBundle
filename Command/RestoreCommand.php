 ...
 */
namespace Sfynx\DatabaseBundle\Command;
...
class RestoreCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('sfynx:database:restore')
            ->setDefinition(array(
...
<info>./app/console sfynx:database:restore "my-connection-service-id" "/var/tmp" [my_sql_file_name.sql]</info>
